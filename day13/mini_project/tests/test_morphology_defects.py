...
from day13.mini_project.src.morphology_engine import MorphologyEngine
from day13.mini_project.src.defect_detector import CarpetDefectDetector
from day13.mini_project.src.generator import (
...
def test_cli_help():
    ...
    res = subprocess.run(
        [sys.executable, "-m", "day13.mini_project.src.defect_cli", "--help"],
        capture_output=True,
        text=True,
    )
