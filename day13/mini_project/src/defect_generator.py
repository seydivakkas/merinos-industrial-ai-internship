"""
generator.py - Synthetic Carpet Fabric & Physical Weaving Defect Fixtures Generator for Day 13.
...
def generate_all_synthetic_defect_fixtures(output_dir: Path) -> Dict[str, str]:
    """Generate the full set of clean and defective carpet fixtures for Day 13."""
