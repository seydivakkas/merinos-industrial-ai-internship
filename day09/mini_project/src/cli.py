...
from day09.mini_project.src.analytics import ImageAnalyticsEngine
from day09.mini_project.src.color_spaces import ColorSpaceConverter
...
from day09.mini_project.src.io_validator import ImageIOValidator
from day09.mini_project.src.resizer import AspectPreservingResizer
...
def run_full_benchmark(output_dir: Path | None = None) -> dict[str, Any]:
    ...
    md_lines = [
        ...
        "",
        "> **Tarih:** 2026-09-04  ",
        "> **Kapsam:** Day 09 - OpenCV Görüntü İşleme ve Analitik Araç Kiti  ",
